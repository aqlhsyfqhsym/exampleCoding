...
<h1>   </h1><br><br>
	...
	<div id="userlist">
     ...
     <h1>  <br>&nbsp;&nbsp;CUSTOMER <br><sub> &nbsp;&nbsp;&nbsp;&nbsp;CUSTOMER REGISTERED LIST</sub> </h1>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        print '<tr>
                 ...
                 <td><a href="deleteuser.php?userName='.$row['userName'].'" ><button type="submit" class="btn btn-danger" role="button" name=submit>DELETE</button></a> </td>

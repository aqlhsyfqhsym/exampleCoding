...
and password='$password'";
  ...
  $rows = mysqli_num_rows($result);
        if($rows==1){
      $_SESSION['stafficnum'] = $stafficnum;
...
<input type="text" name="stafficnum" value="" onFocus="field_focus(this, ' ');" onblur="field_blur(this, 'stafficnum');" class="username" /><br><br>
...
<a href="staffregister.php"><div id="btn2"><b>Sign Up</b></div></a> <!-- End Btn2 -->

...
// mysqli_close($mysqli);
  ...
  //       else
  //       {
  //           echo "<br>DATA FAILED TO ENTER";
  //       }
    
// $result = mysqli_query("INSERT INTO bookingTS() VALUES ('','$name','$ic' ,'$email', '$noPhone','$gender','$national','$cal','$quantity1','$quantity2','$quantity3','$quantity4','$trn_date')");
// if($result)
// {
...
// else
// {
//     die("Record added failed". mysqli_error());
// }
...
?> <center> <br>
 <button > <p><a href="main.php">MAIN PAGE</a></p></button>
  <button onclick="myFunction()" ><p><a href="index.php" >PRINT TICKET</a></p></button><br><br>
</center>

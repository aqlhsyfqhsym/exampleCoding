...
<h1>   </h1><br><br>
	...
	<div id="userlist">
     ...
     <h1>  <br>&nbsp;&nbsp;CONTACT <br><sub> &nbsp;&nbsp;&nbsp;&nbsp;MESSAGE FROM USERS</sub> </h1>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        print '<tr>
                 ...
                 <td>' . $row["email"]. '</td>
                 <td>' . $row["subject"]. '</td> 
                 <td><a href="deletecontact.php?contactid='.$row['contactid'].'" ><button type="submit" class="btn btn-danger" role="button" name=submit>EMAILED</button></a> </td>

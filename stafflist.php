...
<!-- ========================================end user======================= -->
	<div id="stafflist">
        ...
        <h1> <br><br>&nbsp;&nbsp;STAFF <br><sub> &nbsp;&nbsp;&nbsp;&nbsp;REGISTERED STAFF</sub> </h1>
...
{
    echo "<table border=2 cellpadding=5 cellspacing=2>
         <tr>
           <th> ID</th>
           <th>Password</th>
           <th>Full Name</th>
    ...
    while($row = $result->fetch_assoc()) {
        print '<tr>
                 ...
                 <td>' . $row["accountCreated"]. '</td>
                  <td><a href="deletestaff.php?stafficnum='.$row['stafficnum'].'" ><button type="submit" class="btn btn-danger" role="button" name=submit>DELETE</button></a> </td>

<html>
<head> 
 <title>KIDZANIA | Buy Tickets </title>
...
<div id="navbar"> 
   <a><span  style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span> </a>
    <a href="main.php" style="text-align: center;"> <b> GATEAWAY</b> Travel Agency</a>
     <a href=" " style="text-align: center;"> <b> KIDZANIA</a>
...
<div class="header" >
	...
	<div class="w3-content w3-section"> 
	  <img class="mySlides5" src="img/kids1.png" style="width:100%">
      <img class="mySlides5" src="img/kids2.png" style="width:100%">
      <img class="mySlides5" src="img/kids3.png" style="width:100%">
    </div>
</div>
...
function confirmTotalUp() {
    var ask = window.confirm("Are you sure want to book ticket to KidZania ? ");
    if (ask) {
...
<form method="post" action="confirmationbooking.php"> 
  ...
  <p><h3>BUY TICKET</h3><br><span class="error">*required field</span></p>
      ...
      Attraction: <select name="park"> 
        ...
        <option value="KidZania" > Kidzania</option>
   ...
   Booking Date :<input type="date" name="aDate" data-date-inline-picker="false" data-date-open-on-focus="true" /><br><br>
      ...
      <input type="radio"> Admission Ticket  </h2><br>
     <button class="collapsibleC"><input name="national" type="checkbox" value="Malaysian" onclick="none" /> MALAYSIAN </button>
    <div class="contentC">
        <input name="choice[]" type="checkbox" value="1" /> ADULT (Age 18 & Above) : <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RM38.00 <del><sub>RM45.00 </sub></del> &nbsp;&nbsp;


         <input for="choice[]" type="number" name="quantity1" size="6"  min="1" max="100" value="0" /><br/><br/>


        <input name="choice[]" type="checkbox" value="2" /> CHILD (Age 17 & Below) : <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RM72.00 <del><sub>RM85.00 </sub></del> &nbsp;&nbsp;
  ...
  <button class="collapsibleC"><input name="national" type="checkbox" value="Non-Malaysian"/> NON-MALAYSIAN </button>
   ...
   <!--   =================================NOT AVAILABLE=================== -->
         <input type="radio" disabled=""><del>Promo 2Adult + 1 Child</del><font color="red"><sub> SOLD OUT</sub>!!</font> </h2><br>
...
<!-- ===============================FORM====================== -->
     ...
     <p> <i class="fa fa-clock"> AVAILABLE NOW</i><br><br>
       <i class="fa fa-print"> PRINT NOW</i><br><br>
        <i class="fa fa-user"> 9K+ BOOKED</i></p>
        </div> 
...
<!--  //column 01 -->
  ...
  for (i = 0; i < coll.length; i++) {
    ...
    <!-- --------------------end card 1--------------------- -->
   <div class="columnForm34" style="background-color:#f7f7f7;"><br> 
    <p>
         <h3>YOUR KIDS WORLD</h3>
       <div class="timesSquare">
          ...
          <h3><b>Introduction of Attraction</b></h3><br>
            <i class="fa fa-thumbtack" aria-hidden="true"></i>KidZania KL is a kid-sized city where kids between the age of 4-14 experience real-life occupations hands-on in a fun and engaging learning environment. It is also the perfect place to educate kids to be independent, the value of team work, develop skills and also financial literacy! .<br>
            
             <hr>

            <h3><b>What to Expect</b></h3><br>
            <i class="fa fa-thumbs-up" aria-hidden="true"></i> Give your kids a fun day of learning, with over 70 scenarios and careers to try out<br>
             <i class="fa fa-thumbs-up" aria-hidden="true"></i> Children can learn to pilot an airplane, write for a newspaper, put out a fire, and more<br>
             <hr>
         ...
         <br><br>
            ...
            Saturday, Public Holiday and School Holidays: 10:00am-7:00pm<br>
            </i><br>
           Closed on Mondays (except on public and school holidays)<br><br>
